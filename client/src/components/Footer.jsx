...
const Footer = () => {
  ...
  return (
    <footer style={{ background: '#191b23', color: '#e1e2ec', fontFamily: 'Inter, system-ui, sans-serif', padding: '64px 24px 32px' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>

        {/* Grid — 4 cols on desktop → 2 cols on tablet → 1 col on mobile */}
        <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 40, marginBottom: 56 }}>
          ...
          <div>
            ...
            <a href="mailto:support@timeflow.com" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: 14, color: '#adc6ff', textDecoration: 'none', fontWeight: 500 }}>
              <Mail size={15} />
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[{ to: '/', label: 'Home' }, { to: '/about', label: 'About' }, { to: '/register', label: 'Get Started' }].map((l) => (
                <li key={l.to}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[{ href: '#', label: 'Help Center' }, { href: '#', label: 'Privacy Policy' }, { href: '#', label: 'Terms of Service' }].map((l) => (
                <li key={l.label}>
        ...
        <div style={{ borderTop: '1px solid #2e3038', paddingTop: 28, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <p style={{ fontSize: 13, color: '#727785', margin: 0 }}>© {year} TimeFlow. All rights reserved.</p>

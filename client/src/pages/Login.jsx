    ...
    return (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-md mx-auto mt-20">
            <div className="glass p-8 rounded-2xl">
                ...
                {isError && <div className="bg-red-50 text-red-600 p-3 rounded-lg mb-6 text-sm border border-red-100">{message}</div>}
                ...
                <form onSubmit={onSubmit} className="space-y-5">
                    ...
                    <button type="submit" disabled={isLoading} className="w-full bg-indigo-600 text-white font-semibold py-2.5 rounded-lg shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-0.5 transition-smooth disabled:opacity-70 disabled:transform-none">
